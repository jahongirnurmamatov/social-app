  ...
  return (
    <div className='p-4 bg-white rounded-lg shadow-md overflow-scroll text-xs scrollbar-hide'>
      <div className='flex gap-8 w-max'>
        ...
        {/* Story */}
        <div className='flex flex-col items-center gap-2 cursor-pointer'>
          <Image src='https://images.pexels.com/photos/19968907/pexels-photo-19968907/free-photo-of-couple-together-on-desert.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load' width={80} height={80} alt='' className='w-20 h-20 rounded-full ring-2'/>
          <span className='font-medium'>Jahongir</span>
        </div>
        {/* Story */}
        <div className='flex flex-col items-center gap-2 cursor-pointer'>
          <Image src='https://images.pexels.com/photos/21352835/pexels-photo-21352835/free-photo-of-sagrada-familia-in-barcelona-in-spain.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load' width={80} height={80} alt='' className='w-20 h-20 rounded-full ring-2'/>
          <span className='font-medium'>Jahongir</span>
        </div>
        {/* Story */}
        <div className='flex flex-col items-center gap-2 cursor-pointer'>
